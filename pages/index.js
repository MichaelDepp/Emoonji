import { Text, Link, useColorMode, useColorModeValue, IconButton, Box, Center, Container } from '@chakra-ui/react';
						...
						<Box position={'absolute'} bottom="3">
							<Center>
								...
								<Link href="https://github.com/MichaelDepp" isExternal>
									<IconButton colorScheme="none" color={color} aria-label="Github Link" icon={<FaGithub />} />
								</Link>
								<Link href="https://www.linkedin.com/in/michael-singaram-murugan/" isExternal>
									<IconButton colorScheme="none" color={color} aria-label="Linkedin Link" icon={<FaLinkedin />} />
								</Link>
							</Center>
						</Box>
					</Center>
